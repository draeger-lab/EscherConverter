...
public abstract class AbstractEscherBase implements EscherBase {
  ...
  /* (non-Javadoc)
   * @see edu.ucsd.sbrg.escher.model.EscherBase#getUserObject(java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see edu.ucsd.sbrg.escher.model.EscherBase#putUserObject(java.lang.String, T)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see edu.ucsd.sbrg.escher.model.EscherBase#userObjectEntrySet()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see edu.ucsd.sbrg.escher.model.EscherBase#userObjectKeys()
   */
  @Override
