...
public interface EscherOptions extends KeyProvider {
   ...
   */
  Range<OutputFormat> SBML_CONDITION = new Range<>(OutputFormat.class, OutputFormat.SBML);
  /**
   ...
   */
  Option<Boolean> INFER_COMPARTMENT_BOUNDS = new Option<>("INFER_COMPARTMENT_BOUNDS",
          Boolean.class, bundle, Boolean.FALSE);

  /**
   * The desired format for the conversion, e.g., SBML.
   */
  Option<OutputFormat> FORMAT = new Option<>("FORMAT",
          OutputFormat.class, bundle, new Range<>(OutputFormat.class,
   ...
   */
  Option<Double> CANVAS_DEFAULT_WIDTH = new Option<>("CANVAS_DEFAULT_WIDTH",
          Double.class, bundle, new Range<>(Double.class, "{[1,1E9]}"), 250d);
   ...
   */
  Option<Double> CANVAS_DEFAULT_HEIGHT = new Option<>("CANVAS_DEFAULT_HEIGHT",
          Double.class, bundle, new Range<>(Double.class, "{[1,1E9]}"), 250d);
  ...
  Option<String> COMPARTMENT_ID = new Option<>("COMPARTMENT_ID",
          String.class, bundle, bundle.getString("COMPARTMENT_ID_DEFAULT_VALUE"),
          new ValuePairUncomparable<>(FORMAT, SBML_CONDITION));
   ...
   */
  @SuppressWarnings("unchecked")
  Option<String> COMPARTMENT_NAME = new Option<>("COMPARTMENT_NAME",
   ...
   */
  @SuppressWarnings("unchecked")
  Option<String> LAYOUT_NAME = new Option<>("LAYOUT_NAME", String.class,
   ...
   */
  @SuppressWarnings("unchecked")
  Option<String> LAYOUT_ID = new Option<>("LAYOUT_ID", String.class,
   ...
   */
  Option<Double> LABEL_WIDTH = new Option<>("LABEL_WIDTH", Double.class,
          bundle, new Range<>(Double.class, "{[1,1E9]}"), 160d);

  /**
   * With this option you can specify the height of the bounding box of text
   * labels.
   */
  Option<Double> LABEL_HEIGHT = new Option<>("LABEL_HEIGHT", Double.class,
          bundle, new Range<>(Double.class, "{[1,1E9]}"), 50d);
   ...
   */
  @SuppressWarnings("unchecked")
  Option<Double> NODE_DEPTH = new Option<>("NODE_DEPTH", Double.class,
          bundle, new Range<>(Double.class, "{[1,1E9]}"), 1d,
          new ValuePairUncomparable<>(FORMAT, SBML_CONDITION));
   ...
   */
  @SuppressWarnings("unchecked")
  Option<Double> Z = new Option<>("Z", Double.class, bundle,
          new Range<>(Double.class, "{[-1E9,1E9]}"), 0d,
          new ValuePairUncomparable<>(FORMAT, SBML_CONDITION));
   ...
   * should be.
   */
  Option<Double> NODE_LABEL_HEIGHT = new Option<>("NODE_LABEL_HEIGHT",
          Double.class, bundle, new Range<>(Double.class, "{[1,1E9]}"), 20d);
   ...
   */
  Option<Double> REACTION_LABEL_HEIGHT = new Option<>("REACTION_LABEL_HEIGHT",
          Double.class, bundle, new Range<>(Double.class, "{[1,1E9]}"), 30d);
   ...
   */
  Option<Double>
  PRIMARY_NODE_WIDTH = new Option<>("PRIMARY_NODE_WIDTH", Double.class,
          bundle, new Range<>(Double.class, "{[1,1E9]}"), 30d);
   ...
   */
  Option<Double> PRIMARY_NODE_HEIGHT = new Option<>("PRIMARY_NODE_HEIGHT",
          Double.class, bundle, new Range<>(Double.class, "{[1,1E9]}"), 30d);
   ...
   */
  Option<Double> REACTION_NODE_RATIO = new Option<>("REACTION_NODE_RATIO",
          Double.class, bundle, new Range<>(Double.class, "{[0,1]}"), 1d / 2d);
   ...
   */
  Option<Double> SECONDARY_NODE_RATIO = new Option<>("SECONDARY_NODE_RATIO",
          Double.class, bundle, new Range<>(Double.class, "{[0,1]}"), 2d / 3d);
  ...
  OptionGroup<?> GROUP_NAMING = new OptionGroup<Object>("GROUP_NAMING", bundle,
      FORMAT, LAYOUT_ID, LAYOUT_NAME, COMPARTMENT_ID, COMPARTMENT_NAME, INFER_COMPARTMENT_BOUNDS);
