...
public class Geometry {
	...
	public static Point bezier(double t, Point start, Point end, Point b1, Point b2) {
		...
		double b1x = Double.NaN, b1y = Double.NaN, b2x = Double.NaN, b2y = Double.NaN;
	...
	public static void main(String args[]) {
		...
		final double x = 4893.858d/1000d, y = 2802.73025d/1000d, w = 30d, h = 30d;
		...
		JOptionPane.showMessageDialog(null, new JScrollPane(new JPanel() {
			...
			protected void paintComponent(Graphics g)
			{
				...
				g2.draw(new CubicCurve2D.Double(start.getX(), start.getY(), b1.getX(), b1.getY(), b2.getX(), b2.getY(), end.getX(), end.getY()));

				Point2D point = findIntersection(shape, new CubicCurve2D.Double(start.getX(), start.getY(), b1.getX(), b1.getY(), b2.getX(), b2.getY(), end.getX(), end.getY()));
				System.out.println(point);
				if (point != null) {
					g2.setColor(Color.RED);
					g2.fillOval((int) Math.round(point.getX()), (int) Math.round(point.getY()), w + 5, h + 5);
				}
			}
		}));
	}
	...
	public static Point2D.Double bezier(double t, CubicCurve2D curve) {
		...
		return convert(bezier(t, start.getX(), start.getY(), end.getX(), end.getY(), b1.getX(), b1.getY(), b2.getX(), b2.getY()));
	}
